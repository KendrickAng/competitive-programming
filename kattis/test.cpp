...
int main() {
    ...
    max_flow mf(3);
    bool directed = false;
    mf.add_edge(0, 1, 1, directed);
    mf.add_edge(1, 2, 1, directed);
    // mf.add_edge(3, 3, 1, directed);
    // mf.add_edge(3, 2, 1, directed);
    // mf.add_edge(2, 5, 1, directed);
    // mf.add_edge(3, 4, 1, directed);
    // mf.add_edge(4, 5, 1, directed);
    cout << mf.edmonds_karp(0, 2) << endl;
    // mf.add_edge(0,1,1,directed);
    // mf.add_edge(0,2,1,directed);
    // mf.add_edge(0,3,1,directed);
    // mf.add_edge(1,4,1,directed);
    // mf.add_edge(1,5,1,directed);
    // mf.add_edge(1,6,1,directed);
    // mf.add_edge(2,4,1,directed);
    // mf.add_edge(2,5,1,directed);
    // mf.add_edge(2,6,1,directed);
    // mf.add_edge(3,4,1,directed);
    // mf.add_edge(3,5,1,directed);
    // mf.add_edge(3,6,1,directed);
    // mf.add_edge(4,7,1,directed);
    // mf.add_edge(5,7,1,directed);
    // mf.add_edge(6,7,1,directed);
    // cout << mf.dinic(0,7) << endl;
}